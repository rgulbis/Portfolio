export const skillGroups = [
  {
    title: 'Code',
    items: [
      ['JavaScript', "Interactive front-end work, incl. this site's cube"],
      ['HTML & CSS', 'Making designs from designs and original ideas'],
      ['Tailwind CSS', 'Styling school and personal projects'],
      ['PHP & Laravel', 'Server-side schoolwork'],
...
export const projectBullets = [
  ...
  'Set up Stripe Payments and wired the donation flow end to end.',
  'Made it work on phones, where most of the traffic comes from.',
  'Set up the Latvian and English versions of the site.',
  'Tested and handed it over.',
];

export const experience = [
  {
    meta: 'Jul — Aug 2026 · Montijo, Portugal',
    role: 'Programming Technician, GreenTek',
    kind: 'Erasmus+ placement',
    bullets: [
      'Refurbished used laptops for resale — hardware diagnostics, cleaning, component checks.',
      'Installed and configured Windows on refurbished devices.',
